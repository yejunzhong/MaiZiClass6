...
class TableviewProtocol: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row % 2 == 0 {
            ...
            let cell : SnapTableViewCell = tableView.dequeueReusableCell(withIdentifier: CellSnap) as! SnapTableViewCell
            ...
            if let data : NSDictionary = self.newsArray?[indexPath.row] as? NSDictionary {
                ...
                if let url : String = data["img"] as? String {
                    ...
                    cell.testImageView.kf.setImage(with: URL.init(string: url)!)
            ...
            let cell : ImageTableViewCell = tableView.dequeueReusableCell(withIdentifier: CellImage) as! ImageTableViewCell
            ...
            if let data : NSDictionary = self.newsArray?[indexPath.row] as? NSDictionary {
                ...
                if let url : String = data["img"] as? String {
                    ...
                    cell.bigImageView.kf.setImage(with: URL.init(string: url)!)
